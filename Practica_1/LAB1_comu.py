...
import LAB1_comu_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class LAB1_comu(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB1_comu")
...
def main(top_block_cls=LAB1_comu, options=None):
