...
class lab4g2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab4g2")
        ...
        # Variables
        ##################################################
        self.tablaverdad_constelacion = tablaverdad_constelacion = (1+0j,0.77+0.77j,0+1j,-0.77+0.77j,-1+0j,-0.77-0.77j,0-1j,0.77-0.77j,1.4142-1.4142j,1.4142+1.4142j,-1.4142+1.4142j)
        self.Sps = Sps = 8
        self.Rs = Rs = 32000
        self.samp_rate = samp_rate = Rs*Sps
        self.M = M = len(tablaverdad_constelacion)
        self.variable_0 = variable_0 = samp_rate/Sps
        self.h = h = [1]*Sps
    ...
    def set_Sps(self, Sps):
        ...
        self.set_variable_0(self.samp_rate/self.Sps)
...
def main(top_block_cls=lab4g2, options=None):
